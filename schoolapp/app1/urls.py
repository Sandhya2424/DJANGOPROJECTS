...
urlpatterns = [
    ...
    path('school/<int:i>/', views.Schooldetail.as_view(), name='schooldetail'),
    path('schooljoin/<int:i>/', views.StudentJoin.as_view(), name='studentjoin'),
    path('schoolleave/<int:i>/', views.LeaveSchool.as_view(), name='leaveschool'),
